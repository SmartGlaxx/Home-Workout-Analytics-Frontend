...
import {FaHome, FaPeopleArrows, FaRegClock, FaUserFriends, FaEnvelope, FaUserAlt,
     FaTh, FaBell, FaSignOutAlt, FaChevronCircleDown, FaTools, FaRegEnvelope, FaPlusSquare,
